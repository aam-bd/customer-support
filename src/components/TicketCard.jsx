...
const TicketCard = ({ ticket, onClick }) => {
  const getStatusColor = (status) => {
    switch(status) {
      case 'open': return 'text-green-600 border-green-200';
      case 'in-progress': return 'text-yellow-600 border-yellow-200';
    ...
    >
      <div className="p-5">
        ...
        <div className="flex justify-between items-start mb-3">
          ...
          <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full border ${getStatusColor(ticket.status)}`}>
